...
bin/init : init/init.c
	${CC} ${CFLAGS} init/init.c -o bin/init -lcrypto

bin/atm : atm/atm-main.c atm/atm.c util/hash_table.c util/list.c
	${CC} ${CFLAGS} atm/atm.c atm/atm-main.c util/hash_table.c util/list.c -o bin/atm -lcrypto
